  ...
  Future<void> _loadUserDetails() async {
    ...
    if (user != null) {
      setState(() {
        ...
        userInitial = user.email != null ? user.email![0].toUpperCase() : "A";
      });
    }
  }
                        ...
                        children: [
                          ListTile(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () {
                                Clipboard.setData(const ClipboardData(text: 'ritarcadeonline@gmail.com'));
                              },
                            ),
                          ),
                          ListTile(
                            ...
                            trailing: IconButton(
                              icon: const Icon(Icons.copy, size: 20),
                              onPressed: () {
                                Clipboard.setData(const ClipboardData(text: '+91 97100 77795'));
                              },
                            ),
                          ),
                          const ListTile(
